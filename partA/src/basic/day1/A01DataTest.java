...
public class A01DataTest {
    ...
    // (1)데이터 저장
    int myage = 24;                   //나이
    double weight = 68.3;     //몸무게
    boolean isAdult = true;                //성인 여부
    char grade = 'C';               //등급

    System.out.println("나이 :" + myage);				//(2)데이터 읽기
    ...
    weight = weight - 1.3;           //weight = weight - 1.3 수식을 줄여서 쓰는 형식
    grade= 'B';
    //예, 7년동안 열심히 직장을 다닌 후의 나이      
    myage = myage + 7;
 ...
 *       한 줄씩 실행하며 디버깅하기 : 중단점음 첫 번째 명령어. -> f5로 시작 -> 계속 f10으로 한 라인씩 확인하기
 */    
    }
