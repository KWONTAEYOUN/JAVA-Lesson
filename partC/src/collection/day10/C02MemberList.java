...
public class C02MemberList {
    ...
    public static void main(String[] args) {
        ...
        // 컴파일러는 객체의 hashCode 같으면 equals 검사합니다. 둘 다 통과하면 동일객체로 결정.
        //                      ㄴ remove, indexOf 메소드에 동일 객체 검사할 때 사용.

        System.out.println("현재 리스트 내용 :\n" + list+",크기:"+list.size());
        list.remove(new Member("momo", 23));
        System.out.println("수정후 리스트 내용 :\n" + list+",크기:"+list.size());

        System.out.println("특정 멤버 조회 : " + list.lastIndexOf(new Member("momo", 23)));
