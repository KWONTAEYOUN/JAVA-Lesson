...
public class C03MemberListPrint {
    public static void main(String[] args) {
        ...
        System.out.println("123457890123457890123457890123457890123457890123457890123457890"); 

        System.err.println(String.format("%15s\t %15s", "name", "age"));
        ...
        // 컬렉션에서는 반복자(Iteratr)로 데이터에 접근합니다.
        // 반복자를 이용한 출력
        System.out.println("------------------------반복자를 이용한 출력--------------------------");
        Iterator<Member> iterator = list.iterator();        // list로 선언된 자료구조에 접근 할 반복자 선언
        int count = 0;
        while (iterator.hasNext()) {        // 반복자가 접근 할 다음 데이터가 있으면 참.
