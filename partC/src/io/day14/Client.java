...
public class Client {
    ...
    public static void main(String[] args) {
            ...
            try {
                ...
                socket.connect(new InetSocketAddress("192.168.30.12", 5050));
                System.out.println(" __ 연결성공 하였습니다. ");
                ...
                // 이미지 파일을 서버에 보내기(업로드)
                // String filePath = "C:\\Users\\Administrator\\Downloads\\pet.jpg";
                Map<String, String> map = showDialog();
                String filePath = map.get("folder") + map.get("filename");
                // 파일명을 서버에게 보내 서버도 원래 파일명으로 다운로드 한다.
