...
// Comparable<Member>는 <>에 타입을 표시합니다. - 제너릭 타입
// 제너릭 타입은 클래스 또는 인터페이스의 메소드에게 타입을 매개변수로 전달하기 위한 방식.
// 이 때 타입은 실행 시점에서 결정되기 때문이다. 기본형은 Wrapper 클래스로 사용
...
@Override
public int compareTo(Member o) {    // 메소드의 인자 티입 Member는 <> 제너릭 타입과 같게 만들어집니다.
