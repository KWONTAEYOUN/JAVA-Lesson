...
// 익명의 객체 - 추상클래스 상속 또는 인터페이스 구현할 때
//              클래스 이름이 없이 객체가 생성될 수 있다.
//                      ㄴ Inner Type
public class C23AnonymousClassTest {
    public static void main(String[] args) {
        ...
        // 재정의 해야 할 메소드가 1개 입니다. BeAble 인터페이스의 추상메소드가 1개 입니다.
...
// ★★함수형 인터페이스★★ 정의      (참고)_function 키워드는 c언어, 자바스크립트에서 함수 정의에 사용
