...
public class C24MemberCompareTest {
    ...
    public static void main(String[] args) {
        ...
        System.out.println("\t" + momo.compareTo(nana) + "-> 양수이면 momo가 nana보다 나이가 많다.");
        ...
        System.err.println("초기 members 배열 : " + Arrays.toString(members));
        Arrays.sort(members);   // 애열 요소 Member 객체가 cdompareTo 메소드가 있으므로 정렬 됩니다.
        System.err.println("장렬 후 members 배열 : " + Arrays.toString(members));
