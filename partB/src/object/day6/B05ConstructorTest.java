...
public class B05ConstructorTest {
    public static void main(String[] args) {
        ...
        MyClass4 my3 = new MyClass4("bye", 123);
        System.out.println("\tmy3 field1 : " + my3.getField2());
        System.out.println("\tmy3 field2 : " + my3.getField1());
        ...
        // 결론 : MyClass3 와 같이 생성자 메소드가 직접 정의된 것이 없으면 기본생성자만 사용 가능합니다.
        //                                                        ㄴ 기본 생성자가 생략되어 있는 상태입니다.
        //        MyClass5 와 같이 커스텀 생성자 메소드가 하나라도 정의되어 있으면 기본생성자는 생략하고 사용 못 합니다.
        //          --------------사용하고 싶르면 직접 정의해야 합니다. - public MyClass5() {}
        //                               
