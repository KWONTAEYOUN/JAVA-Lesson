...
public class B08MathTest {
    public static void main(String[] args) {
        ...
        System.out.println("위의 메소드 이용해서 3개의 정수 34, 56, 12의 최대값 최소값 구하기");

        System.out.println("최소값 : " + Math.min(Math.min(34, 56),12));
        System.out.println("최대값 : " + Math.max(Math.max(34, 56),12));

        // Math 클래스에는 기본 수학 공식을 해결하는 메소드 (제곱근, 지수, 반올림, 올림...)를 제공합니다.
