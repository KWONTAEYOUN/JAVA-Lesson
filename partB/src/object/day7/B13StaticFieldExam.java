...
public class B13StaticFieldExam {
    public static void main(String[] args) {
        ...
        System.out.println("Shape.MAX_WDITH = " + Shape.MAX_WIDTH);     // 100
        System.out.println("Diamond.MAX_WDITH = " + Diamond.MAX_WIDTH); // 100 -> 상속 받음
        System.out.println("Triangle.MAX_WDITH = " + Triangle.MAX_WIDTH); // 90 -> 상수 재정의
        
    }
    // 위의 필드들은 모두 public static final
    // public : 모두에게 공개
    // static : 객체없이 사용할 수 있는 필드 또는 값, 정적인 .. 메모리 공유영역에 모여서 저장
    // final 필드 : 값을 변경 못 함.
    // (참고)final 메소드 : 오버라이딩 제한. (못 함)
    // 
    // public static int abc;
    // public final int xyz
    // 위의 2가지 경우보다는 의상 조합이 public static final이 맞습니다.
