...
public class Shape {    
		...
		public static final int MAX_WIDTH=100;    //상수
		// 도형의 너비가 MAX_WIDTH를 넘으면 도화지가 작아서 못 그림....등 기준을 정하는 예시
		// 상수는 상속의 의미가 없습니다.
		
		public Shape(){
			// 아래 커스텀 생성자가 있을 때는 기본생성자 사용하고 싶으면 직접 정의하기!
		...
		// 자식 클래스들이 draw를 재정의 해서 다름 메시지가 출력되게 만들예졍입니다.
		public void draw(){
