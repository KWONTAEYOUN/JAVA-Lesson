...
public class B07ConstructorExam {
    ...
    public static void main(String[] args) {
        ...
        System.out.println("message.equals(temp) ? " + message.equals(str2));   // true
        ...
        sc.nextLine();                             
        //  ㄴ 키보드 입력을 저장하는 버퍼에서 실수 입력의 숫자 뒤에 엔터 친 것이 남아 있으므로 처리하기  
        ...
        System.out.println("위의 입력 테스트에서 nextInt, nextDouble 은 엔터처릴르 안 하므로 다음에 나오는 nextLine으로 자동 저장");
        System.out.println("그래서 nextInt 또는 nextDiouble 대신에 다음 방법을 사용한다 !!!!!!!!!!!!");
        System.out.println("정수 입력 >>> ");
        temp = sc.nextLine();               // 숫자만 입력 가능!
        num = Integer.parseInt(temp);       // 문자열을 int로 변환하는 메소드 사용.
        System.out.println("실수 입력 >>> ");
        temp = sc.nextLine();               // 숫자와 실수 입력 가능!!!
